...
test and shared a blind spot. This suite attacks entity order, grammatical role,
and source-material constructions in both directions. All cases are enforced.
...
CASES = [
    ...
    # "seeded with" places the source in an oblique phrase. It must override the
    # asymmetric backward default just like passive "generated by" does.
    ("N8 forward with source in a 'seeded with' phrase",
...
def main():
    print("=" * 74)
    print("DIRECTION PROBE  (entity order, grammatical role, and source material)")
    print("=" * 74)
    hard_pass = 0
    hard_total = 0
